...
CREATE TABLE public.quotations (
    ...
    supplier_name text DEFAULT '주식회사윤자동'::text NOT NULL,
    supplier_representative text DEFAULT '윤용승'::text NOT NULL,
    supplier_business_number text DEFAULT '632-88-03419'::text NOT NULL,
    supplier_phone text DEFAULT '010-3944-5100'::text NOT NULL,
    supplier_manager text DEFAULT '윤용승'::text NOT NULL,
    ...
    payment_terms text,
    delivery_terms text,
    bank_account text DEFAULT '농협은행 주식회사윤자동 317-0031-0037-21'::text NOT NULL,
    memo text,
    project_id uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
